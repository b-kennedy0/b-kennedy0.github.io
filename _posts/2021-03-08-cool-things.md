...
[URLOpener](https://bradleykennedy.co.uk/apps/url-opener){:target="_blank" rel="noopener"} - An alternative to the above website for those who would like to use a browser other than Chrome.
